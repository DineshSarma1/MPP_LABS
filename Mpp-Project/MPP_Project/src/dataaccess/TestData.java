...
public class TestData {
	...
	public List<Author> allAuthors = new ArrayList<Author>() {
		{
			add(new Author("Dinesh", "Thomas", "641-445-2123", addresses.get(0), "A happy man is he."));
			add(new Author("Puskar", "Thomas", "641-445-2123", addresses.get(0), "A happy wife is she."));
			add(new Author("Saugat", "Pugh", "641-919-3223", addresses.get(1), "Thinker of thoughts."));
			add(new Author("Sudip", "Cleveland", "976-445-2232", addresses.get(2), "Author of childrens' books."));
			add(new Author("Binod", "Connor", "123-422-2663", addresses.get(3), "Known for her clever style."));
		}
	};
	...
	List<User> allUsers = new ArrayList<User>() {
		{
			...
			add(new User("104", "sudip", Auth.LIBRARIAN));
			add(new User("105", "puskar", Auth.ADMIN));
			add(new User("106", "saugat", Auth.BOTH));
			add(new User("107", "dinesh", Auth.LIBRARIAN));
