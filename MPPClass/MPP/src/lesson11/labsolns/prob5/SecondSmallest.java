...
public class SecondSmallest {
	...
	public static void main(String[] args) {
		...
		List<Employee> list2 
		  = Arrays.asList(new Employee("joe", 10000), new Employee("tom", 700000)
				  , new Employee("tommy", 500000)
				  , new Employee("tuktuk", 300000)
				  , new Employee("tiktok", 100000));
		...
		System.out.println("employer testing \n");
		System.out.println(secondSmallest5(list2,Comparator.comparing(Employee::getSalary)));
