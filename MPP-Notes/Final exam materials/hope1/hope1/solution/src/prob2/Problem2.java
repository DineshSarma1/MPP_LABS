...
List<String> list2=	list.stream()
		.filter(x->x.getCheckoutDate().equals(LocalDate.of(2015, 06, 27)))
		.map(e->e.getCopy().getBook().getTitle())
		.sorted(Comparator.comparing(String::length).thenComparing(String::toString)).collect(Collectors.toList());
