...
public class AddBookPanel implements MessageableWindow {
    ...
    private void attachAddBookButtonListener(JButton btn) {
        btn.addActionListener(evt -> {
            ...
            else if(Integer.parseInt(maxCheckoutLen) != 7 && Integer.parseInt(maxCheckoutLen) != 21 ) {
            	displayError("Error: Max Checkout Length should be 7 or 21");
            }
            
            else {
                Address address = new Address("1000 North 4th street", "Fairfield", "IA", "52557");
