...
public class Problem2 {
	...
	public static void main(String[] args) {
		...
		/*
		 * List<String> result = list.stream().filter(cre ->
		 * cre.getCheckoutDate().equals(LocalDate.of(2015, 6, 27))) .map(cre ->
		 * cre.getCopy().getBook().getTitle())
		 * .sorted(Comparator.comparing(String::length,
		 * Comparator.reverseOrder()).thenComparing(String::toString,
